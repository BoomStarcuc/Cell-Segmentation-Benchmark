...
def main():
    ...
    parser.add_argument('--exp-name', type=str, default='featurenet_train_on_all_types_nuclear_2C', 
    ...
    parser.add_argument('--excelname', type=str, default='featurenet_nuclear_2C', help='save masks as tif and outlines as text file for ImageJ')           
