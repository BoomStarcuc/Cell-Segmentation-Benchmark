...
do
    ...
    cp $CONFIG_DIR/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_w_one_for_all.py $CONFIG_DIR/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_w_one_for_all_${tissue}.py 
    sed -i "s/Breast/${tissue}/g" $CONFIG_DIR/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_w_one_for_all_${tissue}.py 
done
...
do
    ...
    echo "OUTPUT_DIR: '$out_dir'/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_w_one_for_all_${tissue}"
    ...
    echo '#SBATCH --gres=gpu:a100:2' >> ${dir}/swin-s-tissuenet-w-${tissue}.slurm
    ...
    echo 'sh mmdetection/tools/dist_train.sh '$CONFIG_DIR'/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_w_one_for_all_'${tissue}'.py 2 --work-dir '$out_dir'/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_w_one_for_all_'${tissue} >> ${dir}/swin-s-tissuenet-w-${tissue}.slurm
