_base_ = './mask_rcnn_swin-t-p4-w7_fpn_ms-crop-50e_coco_tissuenet_w_Breast.py'
pretrained = 'https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_small_patch4_window7_224.pth'  # noqa
model = dict(
    backbone=dict(
        depths=[2, 2, 18, 2],
        init_cfg=dict(type='Pretrained', checkpoint=pretrained)))
# load_from = '/home/hx5239/mmdetection/work_dirs/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_n/epoch_25.pth'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'tissuenet_wholecell_Breast_train.json',
