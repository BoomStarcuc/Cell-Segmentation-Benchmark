...
do
    ...
    cp $CONFIG_DIR/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_n_Breast.py $CONFIG_DIR/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_n_${tissue}.py 
    sed -i "s/Breast/${tissue}/g" $CONFIG_DIR/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_n_${tissue}.py 
done
...
do
    ...
    echo "OUTPUT_DIR: '$out_dir'/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_n_${tissue}"
    ...
    echo '#SBATCH --time=24:0:0' >> ${dir}/swin-s-tissuenet-n-${tissue}.slurm
    ...
    echo 'sh mmdetection/tools/dist_train.sh '$CONFIG_DIR'/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_n_'${tissue}'.py 4 --work-dir '$out_dir'/mask_rcnn_swin-s-p4-w7_fpn_fp16_ms-crop-50e_coco_tissuenet_n_'${tissue} >> ${dir}/swin-s-tissuenet-n-${tissue}.slurm
