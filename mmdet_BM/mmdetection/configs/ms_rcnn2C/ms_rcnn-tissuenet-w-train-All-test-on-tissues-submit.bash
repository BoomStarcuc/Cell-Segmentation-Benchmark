...
dir=$CONFIG_DIR/ms_rcnn_tissuenet_w_all_to_all_test_2C_slurm
out_dir='/shared/rc/spl/mmdet_output/All_to_all/wholecell/MSRCNN'
if [[ ! -e $dir ]]; then
    mkdir $dir
elif [[ ! -d $dir ]]; then
...
do
    ...
    echo 'python mmdetection/tools/test.py '$CONFIG_DIR'/ms_rcnn_r50_caffe_fpn_2x_coco_tissuenet_w_train_all_test_on_'${tissue}'.py '$out_dir'/epoch_1.pth --out '$out_dir'/predictions/ms_rcnn_r50_caffe_fpn_2x_coco_tissuenet_w_train_all_test_on_'${tissue}'/results.pkl --work-dir '$out_dir'/predictions/ms_rcnn_r50_caffe_fpn_2x_coco_tissuenet_w_train_all_test_on_'${tissue}' --eval segm' >> ${dir}/ms_rcnn-tissuenet-w-train-all-test-on-${tissue}.slurm
