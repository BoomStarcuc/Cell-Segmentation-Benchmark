...
dir=$CONFIG_DIR/rfnext_tissuenet_n_all_to_all_test_slurm
out_dir='/shared/rc/spl/mmdet_output/All_to_all/nuclear_oc/rfnext_fixed_multi_branch_cascade_mask_rcnn_r2_101_fpn_200e_coco_tissuenet_n'
if [[ ! -e $dir ]]; then
    mkdir $dir
elif [[ ! -d $dir ]]; then
