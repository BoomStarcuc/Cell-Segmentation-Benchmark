...
def main():
    ...
    parser.add_argument('--exp-name', type=str, default='stardist_train_on_all_types_wholecell_2C', 
    ...
    parser.add_argument('--excelname', type=str, default='featurenet_nuclear')                             
    ...
    val_dict = np.load(os.path.join(data_dir, 'tissuenet_test_split_256x256_memserpreprocess.npz'), allow_pickle=True)
    train_dict = np.load(os.path.join(data_dir, 'tissuenet_val_split_256x256_memserpreprocess.npz'), allow_pickle=True)
