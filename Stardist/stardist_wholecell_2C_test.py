...
def main():
    ...
    parser.add_argument('--excelname', type=str, default='Stardist_wholecell_2C')                    
    ...
    use_gpu = False and gputools_available()
    # print("gpu availalbe", gputools_available())
    ...
    X_test1 = [normalize(x, 0, 99.8, axis=axis_norm) for x in tqdm(X_test)]
    X_test2 = np.empty([len(X_test1), 256, 256, 2])
