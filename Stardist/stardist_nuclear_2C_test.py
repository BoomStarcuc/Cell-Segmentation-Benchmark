...
def main():
    ...
    parser.add_argument('--exp-name', type=str, default='stardist_train_on_all_types_nuclear_2C', 
    ...
    parser.add_argument('--excelname', type=str, default='Stardist_nuclear_2C')                    
